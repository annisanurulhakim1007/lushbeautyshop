...
class __TwigTemplate_9472da6a6f88d6df2f276ee901b29c5d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        yield "
<div class=\"layout-product-form layout-commerce-form\">
  <div class=\"layout-region layout-region--commerce-main\">
    <div class=\"layout-region__content\">
      ";
        // line 16
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["form"] ?? null), 16, $this->source), "advanced", "footer", "actions"), "html", null, true);
        yield "
    </div>
  </div>
  ...
  <div class=\"layout-region layout-region--commerce-footer\">
    ";
        // line 23
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "footer", [], "any", false, false, true, 23), 23, $this->source), "html", null, true);
        yield "
    ";
        // line 24
...
";
    ...
    {
        return new Source("", "modules/contrib/commerce/modules/product/templates/commerce-product-form.html.twig", "C:\\xampp\\htdocs\\drupalwebsite\\modules\\contrib\\commerce\\modules\\product\\templates\\commerce-product-form.html.twig");
    }
